    ...
    public static void main(String[] args)
    {
        ...
        javax.swing.SwingUtilities.invokeLater(new Runnable()
        {
            public void run()
            {
                ...
                Document shareDocument = t1.getDocument();
                t2.setDocument(shareDocument);
                t3.setDocument(shareDocument);
                ...
                // SET THE SAME DOCUMENT FOR THE 3
                BoundedRangeModel sharedModel = s1.getModel();
                s2.setModel(sharedModel);
                s3.setModel(sharedModel);
